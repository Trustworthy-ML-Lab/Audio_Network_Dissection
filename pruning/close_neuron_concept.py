...
from data_utils import get_label_to_cls, get_target_model, read_json
...
def main():
	...
	with open(os.path.join(args.save_pruning_dir, f"concept-{args.target_name}-{args.pruning_strategy}.json"), "w") as f:
